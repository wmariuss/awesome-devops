...
- On-premises
  ...
  - [SVRF](https://github.com/nybarius/SVRF) - Merge train that batches, gates and lands pull requests for repositories where CI can't keep up with pull request volume.
- Public Services
