...
- [Shep](https://github.com/shep-ai/cli) - AI-native SDLC platform that orchestrates coding agents (Claude Code, Cursor, Gemini) for autonomous feature development with approval gates and a web dashboard.
