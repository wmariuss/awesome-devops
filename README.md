...
- [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) - Records an AI agent or service at its LLM-provider boundary and replays the run offline, with no provider call and no API key.
