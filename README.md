...
- [TerraChat](https://www.terrachat.io/) - Generate AWS infrastructure from plain English descriptions. Includes cost estimates, security checks, and built-in state management.
