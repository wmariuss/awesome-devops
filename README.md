...
- [Nika](https://github.com/supernovae-st/nika) - Workflow engine for AI and automation tasks: reviewable YAML DAGs, statically checked (schema, permits, cost) before execution, tamper-evident traces after.
